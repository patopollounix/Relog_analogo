...
notification = Notify()
notification.title = "Relog-Alarma"
notification.message = "Se a ejecutado la aplicacion"
notification.send()
...
def update_clock():
    ...
    # alarma
    if now.tm_min % 50 == 0 and now.tm_sec == 0:
        duration = 1000  # milliseconds
        freq = 440  # Hz
        winsound.Beep(freq, duration)

    # Actualisacion de las felchas
...
notification = Notify()
notification.title = "Relog-Alarma"
notification.message = "Se a terminado el proceso de la Aplicacon"
notification.send() 
